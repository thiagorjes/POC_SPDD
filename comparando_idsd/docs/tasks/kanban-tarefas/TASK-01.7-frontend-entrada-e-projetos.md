...
- **Status:** concluída — os seis bloqueantes da revisão fechados e medidos; critério 9 declaradamente não medido, dono TASK-02.2; ACH-16 (RNF-005 sem dono em nenhuma task) fora do alcance desta, dono `/tasks`
- **Sistema:** idsd
- **Executor:** misto
- **Tentativas:** 4
- **Esforço:** M
