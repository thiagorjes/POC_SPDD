...
| --- | --- | --- |
| `backend/src/main/java/<pkg>/internal/projeto/EtapaController.java` | criar | duas rotas |
| `backend/src/main/java/<pkg>/internal/projeto/EtapaService.java` | criar | substituição transacional do fluxo |
| `backend/src/main/java/<pkg>/internal/projeto/FluxoRequisicao.java` | criar | registro de entrada |
| `backend/src/main/java/<pkg>/internal/projeto/EtapaResposta.java` | criar | registro de saída |
