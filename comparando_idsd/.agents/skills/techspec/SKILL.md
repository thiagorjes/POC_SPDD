...
name: techspec
description: >
  Traduz os cenários congelados do PRD em decisões técnicas — arquitetura,
  modelo de dados, contratos, testes, segurança e rastreabilidade. Decide como,
  nunca o quê: escopo novo descoberto aqui volta para o /prd. Não satisfaz gate
  próprio; alimenta o /analyze. Use após o /prd, antes do /analyze.
camada: execution
satisfaz-gates: []
template: .agents/templates/techspec-template.md
input-artifacts:
...
output-artifacts:
  ...
  - docs/techspec/{{FEATURE}}/contracts/*.md
  - docs/techspec/{{FEATURE}}/quickstart.md
  - docs/techspec/{{FEATURE}}-research.md
