...
name: code-review
description: >
  Revisa o épico implementado contra a task, a especificação e os envelopes de
  RNF, com análise de segurança obrigatória. O revisor não escreve código:
  achado é devolvido a quem implementa. Satisfaz a revisão técnica e o gate de
  NFR. Use ao fechar o épico, antes do merge.
camada: execution
satisfaz-gates: [GATE-REVISAO-TECNICA, GATE-NFR]
template: .agents/templates/review-template.md
input-artifacts:
...
output-artifacts:
  - docs/review/{{FEATURE}}/{{EPIC}}-review.md
---
